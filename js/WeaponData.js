...
{"use strict";                             //ground,helo   air,  acc,stab,ap, he,   rof,   supp, tags, rounds name
    ...
    MainArmory[1018]= new Weapon(   455,  455,     0,   30, 30,   0,  1.00, "240",   30, "", "9mm PB", "Kpist m/45B");    //shock
    MainArmory[1017]= new Weapon(   455,  455,     0,   40, 40,   0,  1.00, "533",   30, "", "9mm PB", "Newnanbu M66");   //shock JSDF only
    ...
    MainArmory[431] = new Weapon(   595,  595,     0,   40, 10,   0,  1.00,  "75",   55, "", "7.62mm", "L1A1 SLR");       //line
    MainArmory[459] = new Weapon(   595,  595,     0,   60, 15,   0,  1.00, "120",   55, "", "7.62mm", "AG-3");           //shock
    MainArmory[463] = new Weapon(   595,  595,     0,   40, 10,   0,  1.00, "120",   55, "", "7.62mm", "AK4");            //shock, norrlandsjagare only
    MainArmory[460] = new Weapon(   595,  595,     0,   60, 15,   0,  1.00, "120",   55, "", "7.62mm", "C1A1 SLR");       //shock, vandoos only
    MainArmory[986] = new Weapon(   595,  595,     0,   60, 15,   0,  1.00, "120",   55, "", "7.62mm", "FAL");            //shock (Stoottroepen, Vuurploeg)
    MainArmory[847] = new Weapon(   595,  595,     0,   60, 15,   0,  1.00, "120",   55, "", "7.62mm", "Gv M75");         //shock
    MainArmory[461] = new Weapon(   595,  595,     0,   60, 15,   0,  1.00, "171",   55, "", "7.62mm", "H&K G3A2");       //shock
    MainArmory[688] = new Weapon(   595,  595,     0,   60, 15,   0,  1.00, "120",   55, "", "7.62mm", "Howa 64 Shiki");  //shock, hudou ren only
    MainArmory[462] = new Weapon(   595,  595,     0,   60, 15,   0,  1.00, "75",    55, "", "7.62mm", "L1A1 SLR");       //shock
    ...
    MainArmory[719] = new Weapon(   595,  595,     0,   80, 20,   0,  1.00,  "75",   55, "", "7.62mm", "L1A1 SLR");       //elite,
    ...
    //MG
    MainArmory[708] = new Weapon(   875,  595,     0,   40, 20,   0,  0.50, "249",   55, "", "7.62mm", "Kg m/37");          //militia
    MainArmory[497] = new Weapon(   875,  595,     0,   40,  0,   0,  0.50, "272",   55, "[STAT]","7.62mm", "62 Shiki");    //line (honbuhan, shojobuntai)
    MainArmory[489] = new Weapon(   875,  595,     0,   30, 15,   0,  0.50, "450",   55, "[CQC]", "7.7mm", "Bren L4");      //line diggers <<same as shock
    MainArmory[518] = new Weapon(   875,  595,     0,   50,  0,   0,  0.50, "340",   55, "[STAT]","7.62mm", "C6");          //line
    MainArmory[991] = new Weapon(   875,  595,     0,   50,  0,   0,  0.50, "340",   55, "[STAT]","7.62mm", "FN MAG");      //line hq, grenadiers
	  MainArmory[658] = new Weapon(   875,  595,     0,   40,  0,   0,  0.50, "340",   45, "[STAT]","6.5mm", "Ksp m/58");     //line
    MainArmory[728] = new Weapon(   875,  595,     0,   50,  0,   0,  0.50, "340",   55, "[STAT]","7.62mm", "L7A1");        //line
    MainArmory[731] = new Weapon(   770,  595,     0,   60, 25,   0,  0.50, "318",   40, "[CQC]", "5.56mm", "L86 LMG");     //line, fusiliers only
    MainArmory[745] = new Weapon(   875,  525,     0,   50,  0,   0,  0.50, "340",   55, "[STAT]","7.62mm", "M240");        //line, tacom, light rifles
    MainArmory[760] = new Weapon(   875,  595,     0,   20,  0,   0,  0.50, "420",   55, "[STAT]","7.62mm", "M60");         //line rifles, sochongsu,  bonbu
    MainArmory[795] = new Weapon(   875,  595,     0,   20,  0,   0,  0.50, "594",   55, "[STAT]","7.62mm", "MG3");         //line
    MainArmory[800] = new Weapon(   770,  595,     0,   30, 10,   0,  0.50, "594",   40, "[CQC]", "5.56mm", "MINIMI");      //line <<all same
    MainArmory[127] = new Weapon(   875,  595,     0,   20,  0,   0,  0.50, "420",   55, "[STAT]","7.62mm", "NF-1");        //line
    MainArmory[820] = new Weapon(   875,  595,     0,   20,  0,   0,  0.50, "420",   55, "[STAT]","7.62mm", "PKM");         //line
    MainArmory[1013]= new Weapon(   770,  595,     0,   50, 25,   0,  0.50, "409",   55, "[CQC]", "7.62mm", "RPK");         //line //only fuhrungstrupp
    MainArmory[935] = new Weapon(   980,  595,     0,   30,  0,   0,  0.50, "296",   55, "[STAT]", "7.62mm", "TYPE 67");    //line
    ...
    MainArmory[717] = new Weapon(   875,  595,     0,   60, 30,   0,  0.50, "420",   45, "[CQC]", "6.5mm", "Ksp m/58B");    //shock norrlandsjagare <<same as elite
    MainArmory[666] = new Weapon(   875,  595,     0,   50,  0,   0,  0.50, "340",   55, "[STAT]","7.62mm", "L7A1");        //shock, green jackets
    ...
    MainArmory[287] = new Weapon(   875,  595,     0,   60, 30,   0,  0.50, "420",   45, "[CQC]", "6.5mm", "Ksp m/58B");    //elite, kustjagare
    ...
    MainArmory[873] = new Weapon(   770,  595,     0,   50, 25,   0,  0.50, "381",   40, "[CQC]", "5.45mm", "RPK-74");      //shock
    MainArmory[1014]= new Weapon(   770,  595,     0,   50, 25,   0,  0.50, "381",   40, "[CQC]", "5.45mm", "RPK-74");      //elite
    MainArmory[902] = new Weapon(   770,  595,     0,   50, 25,   0,  0.50, "394",   40, "[CQC]", "5.56mm", "STONER 63");   //elite
    MainArmory[1016]= new Weapon(   770,  595,     0,   40, 20,   0,  0.50, "468",   40, "[CQC]", "7.62mm", "Type 81");     //elite

    MainArmory[573] = new Weapon(   875,  525,     0,   20, 10,   0,  0.50, "652",   55, "", "7.62mm", "62 Shiki");         //veh
    MainArmory[519] = new Weapon(   875,  595,     0,   40,  5,   0,  0.50, "340",   45, "", "6.5mm", "Ksp m/58");          //veh, fallskarmsjagare (wtf?)
    ...
    MainArmory[762] = new Weapon(  1050,  525,     0,   10,  5,   0,  0.50, "652",   55, "", "7.62mm", "M60E3");            //vehicle
...
function SetTransports(){
    ...
    TransportArray[ 218][0] = [ 384, 288, 289, 674, 679, 678];
    TransportArray[ 219][0] = [ 384, 288, 289, 674, 679, 678];
    TransportArray[ 832][0] = [ 384, 288, 289, 674, 679, 678];
    ...
    TransportArray[ 169][0] = [ 169, 626, 855];
