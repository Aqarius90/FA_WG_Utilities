...
function SetTransports(){
    TransportArray[ 519][0] = new int[] { 332, 384, 674, 679, 678, 0};
    TransportArray[  50][0] = new int[] { 288, 289, 674, 679, 678, 0};
    TransportArray[  42][0] = new int[] { 332, 384, 282, 290, 674, 679};
    TransportArray[ 106][0] = new int[] { 384, 527, 613, 615,   0, 0};
    TransportArray[ 218][0] = new int[] { 384, 288, 289, 674, 679, 678};
    TransportArray[ 219][0] = new int[] { 384, 288, 289, 674, 679, 678};
    TransportArray[ 832][0] = new int[] { 384, 288, 289, 674, 679, 678};
    TransportArray[ 472][0] = new int[] { 384, 674, 679, 678};
    TransportArray[ 806][0] = new int[] { 384, 674, 679, 678};
    TransportArray[ 521][0] = new int[] { 332, 384, 527, 678, 613};
    TransportArray[ 452][0] = new int[] { 332, 384, 674, 679, 615};
    TransportArray[ 455][0] = new int[] { 384, 288, 289, 330, 328, 329, 674, 679};
    TransportArray[ 805][0] = new int[] { 384, 288, 289, 330, 328, 329, 674, 679};
    TransportArray[ 833][0] = new int[] { 384, 229, 230, 678};
    TransportArray[ 520][0] = new int[] { 229, 230, 678, 613};
    TransportArray[ 804][0] = new int[] { 229, 230, 678, 613};
    TransportArray[ 517][0] = new int[] { 419, 847, 470, 118, 632, 634};
    TransportArray[ 145][0] = new int[] { 847, 470, 118, 124, 125, 863, 632, 634};
    TransportArray[ 809][0] = new int[] { 847, 470, 118, 124, 125, 863, 632, 634};
    TransportArray[ 148][0] = new int[] { 419, 847, 470, 824};
    TransportArray[ 518][0] = new int[] { 847, 470, 824};
    TransportArray[ 811][0] = new int[] { 847, 470, 824};
    TransportArray[ 217][0] = new int[] { 847, 470, 118, 632, 634};
    TransportArray[ 180][0] = new int[] { 847, 470, 118, 632, 634};
    TransportArray[ 392][0] = new int[] { 847, 470, 118, 632, 634};
    TransportArray[ 814][0] = new int[] { 847, 470, 118, 632, 634};
    TransportArray[ 417][0] = new int[] { 847, 470, 632, 634};
    TransportArray[ 812][0] = new int[] { 847, 470, 118, 632, 634};
    TransportArray[ 434][0] = new int[] { 847, 470, 232, 121, 632, 634};
    TransportArray[ 813][0] = new int[] { 847, 470, 121, 632, 634};
    TransportArray[ 464][0] = new int[] { 632, 634, 824};
    TransportArray[ 808][0] = new int[] { 419, 847, 470, 632, 634, 824};
    TransportArray[ 492][0] = new int[] { 129};
    TransportArray[  01][0] = new int[] { 539, 528, 532, 657, 599};
    TransportArray[  39][0] = new int[] { 843, 528, 532, 657, 599};
    TransportArray[  40][0] = new int[] { 843, 528, 532, 05, 657, 599};
    TransportArray[  98][0] = new int[] { 843, 528, 532, 05, 657, 599};
    TransportArray[ 800][0] = new int[] { 843, 528, 532, 05, 657};
    TransportArray[  99][0] = new int[] { 843, 528, 532, 05, 657};
    TransportArray[ 110][0] = new int[] { 528, 532, 657, 661, 599};
    TransportArray[ 416][0] = new int[] { 539, 528, 532, 657, 661};
    TransportArray[ 156][0] = new int[] { 539, 843, 528, 532, 657, 661};
    TransportArray[ 801][0] = new int[] { 539, 843, 528, 532, 657, 661};
    TransportArray[ 236][0] = new int[] { 528, 532, 657, 661};
    TransportArray[ 237][0] = new int[] { 528, 532, 657, 661};
