...
{"use strict";                             //ground,helo   air,  acc,stab,ap, he,   rof,   supp, tags, rounds name
    ...
    MainArmory[1049] = new Weapon(  2975,    0,     0,   50,  0,  27,  0.00, "20S", 150, "[HEAT][GUID]", "SALH missile", "Spike NLOS");
    MainArmory[1050] = new Weapon(  2975,    0,     0,   60,  0,  27,  0.00, "30S", 150, "[HEAT][GUID]", "SALH missile", "Spike NLOS");
    ...
    MainArmory[1068] = new Weapon(  2100,    0,     0,   45, 15,  16,  3.00, "7",  115, "[KE][AOE]", "100mm", "T69-II");
    ...
    MainArmory[1076] = new Weapon(  1050, 2625,  2450,   50, 20,   0,  1.00, "949",  120, "[AOE][RAD]", "30mm", "M-86");
    MainArmory[1077] = new Weapon( 11200,    0,     0, 5460,  0,   0,  5.00, "5",  235, "[AOE][CORR][STAT][SMK]", "105mm", "M2");
    MainArmory[1078] = new Weapon(     0, 2800,  4550,   65,  0,   0,  9.00, "30S", 360, "[AOE][GUID]", "SACLOS missile", "V-600PT");
    MainArmory[1079] = new Weapon(     0, 2800,  2275,   60, 60,   0,  6.00, "10S", 240, "[AOE][FF]", "IR missile", "9M333");
    ...
    MainArmory[1083] = new Weapon( 12250,    0,     0, 2730,  0,   0,  8.00, "15",  312, "[AOE][CORR][STAT][SMK]", "128m rockets", "M-94 Plamen-S");
    ...
    MainArmory[1115] = new Weapon(  1400,    0,     0,   40,  0,  10,  0.00, "7",  190, "[HEAT][STAT]", "82mm HEAT", "BsT M-60A");//inf
    MainArmory[1116] = new Weapon(  3500,    0,     0,   10,  0,   0,  0.00, "42",  150, "[NPLM]", "340kg iron bombs", "PLAB 350");
    MainArmory[1117] = new Weapon(  3500,    0,     0,   60, 60,  30,  0.00, "2s",  150, "[HEAT][FF]", "TV guidance missile", "GROM-B");
    ...
    MainArmory[1123] = new Weapon(  1400,    0,     0,   40, 20,  10,  2.00, "13",  190, "[HEAT][STAT]", "82mm HEAT", "BsT M-60A");//veh
    ...
    MainArmory[1128] = new Weapon(  2100,    0,     0,   40, 10,  12,  3.00, "7",  115, "[KE][AOE]", "105mm", "D-10T");
    MainArmory[1129] = new Weapon(  2450,    0,     0,   40,  5,  17,  0.00, "10s",  150, "[HEAT][SA]", "SACLOS misile", "Maljutka-P1");
    MainArmory[1130] = new Weapon(  2275,    0,     0,   60, 30,  13,  3.00, "7",  115, "[KE][AOE]", "105mm", "D-10T");
    MainArmory[1131] = new Weapon(  2275,    0,     0,   60, 30,  15,  3.00, "7",  115, "[KE][AOE]", "105mm", "D-10T");
    ...
    MainArmory[1165] = new Weapon(  1050, 2625,  1750,   35,  0,   0,  1.00, "472",   92, "[AOE][STAT]", "23mm", "ZU-23-2");
    MainArmory[1166] = new Weapon(  1400,    0,     0,   40,  0,  16,  2.00, "7",  380, "[HEAT][STAT][AOE]", "95mm HEAT", "Musti");//veh
    MainArmory[1167] = new Weapon( 30100,    0,     0, 6370,  0,   0,  7.00, "7",  350, "[AOE][CORR][STAT][SMK]", "152mm", "2A36");
    ...
    MainArmory[1171] = new Weapon(  1925,    0,     0,   30,  0,   8,  3.00, "8",   97, "[KE][STAT][AOE]", "84mm", "QF 20-PDR");
    MainArmory[1172] = new Weapon(  2100,    0,     0,   35,  0,  20,  0.00, "20s", 150, "[HEAT][GUID]", "MCLOS misile", "Vigilant");
    MainArmory[1173] = new Weapon(     0, 3325,  2625,   60,  0,   0,  6.00, "30s",  240, "[AOE][GUID]", "Saclos misile", "Crotale NG");
    ...
    MainArmory[1176] = new Weapon(  2275,    0,     0,   70, 15,  17,  3.00, "7",  115, "[KE][AOE]", "100mm", "D-10T");
    ...
    //small arms
    MainArmory[433] = new Weapon(   525,  525,     0,   23, 10,   0,  1.00, "128",   40, "", "7.62mm", "Mpi-K");          //militia
    ...
    MainArmory[447] = new Weapon(   525,  525,     0,   30, 15,   0,  1.00, "216",   40, "", "5.56mm", "F88 Austeyr");    //line
    MainArmory[449] = new Weapon(   525,  525,     0,   30, 15,   0,  1.00, "160",   40, "", "5.56mm", "FAMAS");          //line
    MainArmory[451] = new Weapon(   525,  525,     0,   30, 15,   0,  1.00, "160",   40, "", "5.56mm", "K2");             //line
    MainArmory[445] = new Weapon(   525,  525,     0,   30, 15,   0,  1.00, "160",   40, "", "7.62mm", "kbk AKM");        //line
    MainArmory[452] = new Weapon(   525,  525,     0,   30, 15,   0,  1.00, "160",   40, "", "5.56mm", "L85");            //line
    ...
    MainArmory[646] = new Weapon(   525,  525,     0,   30, 15,   0,  1.00, "160",   40, "", "7.62mm", "kbk AKM");        //line
    ...
    MainArmory[701] = new Weapon(   525,  525,     0,   30, 15,   0,  1.00, "160",   40, "", "5.56mm", "Howa 89 Shiki");  //line
    ...
    MainArmory[1023]= new Weapon(   525,  525,     0,   45, 23,   0,  1.00, "232",   40, "", "5.56mm", "Galil");          //shock
    ...
    MainArmory[478] = new Weapon(   525,  525,     0,   45, 23,   0,  1.00, "232",   40, "", "5.56mm", "CAR-15");         //shock
    MainArmory[984] = new Weapon(   525,  525,     0,   45, 23,   0,  1.00, "342",   40, "", "5.56mm", "F88 Austeyr");    //shock, comandos only
    MainArmory[988] = new Weapon(   525,  525,     0,   45, 23,   0,  1.00, "232",   40, "", "5.56mm", "FAMAS");          //shock
    ...
    MainArmory[479] = new Weapon(   525,  525,     0,   45, 23,   0,  1.00, "232",   40, "", "5.56mm", "K2");             //shock haebyung only
    MainArmory[480] = new Weapon(   525,  525,     0,   45, 23,   0,  1.00, "232",   40, "", "5.56mm", "L85");            //shock, paras only
    ...
    MainArmory[1149] = new Weapon(  525,  525,     0,   45, 23,   0,  1.00, "232",   40, "", "7.62mm", "Rk 90 TP");          //shock
    MainArmory[529] = new Weapon(   525,  525,     0,   60, 30,   0,  1.00, "355",   40, "", "7.62mm", "AK5");            //elite kustyagare90 only
    MainArmory[524] = new Weapon(   525,  525,     0,   60, 30,   0,  1.00, "355",   40, "", "7.62mm", "AKM");            //Elite, navy seals only
    MainArmory[639] = new Weapon(   525,  525,     0,   60, 30,   0,  1.00, "355",   40, "", "5.56mm", "C7");             //elite
    MainArmory[526] = new Weapon(   525,  525,     0,   60, 30,   0,  1.00, "533",   40, "", "5.56mm", "AUG Para");       //elite
    MainArmory[531] = new Weapon(   595,  595,     0,   60, 30,   0,  1.00, "355",   55, "", "7.62mm", "H&K G3KA4");      //elite
    MainArmory[553] = new Weapon(   525,  525,     0,   60, 60,   0,  1.00, "533",   40, "", "4.73mm", "H&K G11");        //elite
    ...
    MainArmory[527] = new Weapon(   525,  525,     0,   60, 30,   0,  1.00, "355",   40, "", "5.56mm", "Carbine M727");   //elite
    MainArmory[528] = new Weapon(   525,  525,     0,   60, 30,   0,  1.00, "355",   40, "", "5.56mm", "L85");            //elite royal marines 90 only
    MainArmory[738] = new Weapon(   525,  525,     0,   60, 30,   0,  1.00, "355",   40, "", "5.56mm", "m/85");           //elite
    MainArmory[884] = new Weapon(   525,  525,     0,   60, 30,   0,  1.00, "355",   55, "", "7.62mm", "SG-543");         //elite
    ...
    MainArmory[640] = new Weapon(   525,  525,     0,   60, 30,   0,  1.00, "355",   40, "", "5.56mm", "Howa 89F Shiki"); //elite
    MainArmory[1045]= new Weapon(   525,  525,     0,   60, 30,   0,  1.00, "355",   40, "", "5.56mm", "Gillon");         //elite
    MainArmory[1145]= new Weapon(   525,  525,     0,   60, 30,   0,  1.00, "355",   40, "", "7.62mm", "Rk 62/76 TP");         //elite
    ...
    MainArmory[813] = new Weapon(   455,  455,     0,   40, 40,   0,  1.00, "533",   30, "", "9mm PB", "Newnanbu M66");   //elite, kutei only
    ...
    //battle rifles
    MainArmory[985] = new Weapon(   595,  595,     0,   30,  5,   0,  1.00,  "75",   55, "", "7.62mm", "FAL");            //militia (natres)
    MainArmory[407] = new Weapon(   595,  595,     0,   30,  5,   0,  1.00,  "75",   55, "", "7.62mm", "H&K G3");         //militia
    MainArmory[408] = new Weapon(   595,  595,     0,   30,  5,   0,  1.00,  "75",   55, "", "7.62mm", "L1A1 SLR");       //militia
    MainArmory[425] = new Weapon(   595,  595,     0,   40, 10,   0,  1.00, "120",   55, "", "7.62mm", "AG-3");           //line
    MainArmory[427] = new Weapon(   595,  595,     0,   40, 10,   0,  1.00, "120",   55, "", "7.62mm", "AK4");            //line
    MainArmory[426] = new Weapon(   595,  595,     0,   40, 10,   0,  1.00, "120",   55, "", "7.62mm", "C1A1 SLR");       //line
    MainArmory[692] = new Weapon(   595,  595,     0,   40, 10,   0,  1.00, "120",   55, "", "7.62mm", "FAL");            //line, huzaren, grens
    MainArmory[428] = new Weapon(   595,  595,     0,   40, 10,   0,  1.00, "120",   55, "", "7.62mm", "Gv M75");         //line
    MainArmory[429] = new Weapon(   595,  595,     0,   40, 10,   0,  1.00, "120",   55, "", "7.62mm", "H&K G3A2");       //line
    MainArmory[638] = new Weapon(   595,  595,     0,   40, 10,   0,  1.00, "120",   55, "", "7.62mm", "Howa 64 Shiki");  //line
    MainArmory[431] = new Weapon(   595,  595,     0,   40, 10,   0,  1.00, "120",   55, "", "7.62mm", "L1A1 SLR");       //line
    MainArmory[459] = new Weapon(   595,  595,     0,   60, 15,   0,  1.00, "171",   55, "", "7.62mm", "AG-3");           //shock
    MainArmory[463] = new Weapon(   595,  595,     0,   60, 15,   0,  1.00, "171",   55, "", "7.62mm", "AK4");            //shock, norrlandsjagare only
    MainArmory[460] = new Weapon(   595,  595,     0,   60, 15,   0,  1.00, "171",   55, "", "7.62mm", "C1A1 SLR");       //shock, vandoos only
    MainArmory[986] = new Weapon(   595,  595,     0,   60, 15,   0,  1.00, "171",   55, "", "7.62mm", "FAL");            //shock (Stoottroepen, Vuurploeg)
    MainArmory[847] = new Weapon(   595,  595,     0,   60, 15,   0,  1.00, "171",   55, "", "7.62mm", "Gv M75");         //shock
    MainArmory[461] = new Weapon(   595,  595,     0,   60, 15,   0,  1.00, "171",   55, "", "7.62mm", "H&K G3A2");       //shock
    MainArmory[688] = new Weapon(   595,  595,     0,   60, 15,   0,  1.00, "171",   55, "", "7.62mm", "Howa 64 Shiki");  //shock, hudou ren only
    MainArmory[462] = new Weapon(   595,  595,     0,   60, 15,   0,  1.00, "171",   55, "", "7.62mm", "L1A1 SLR");       //shock
    MainArmory[219] = new Weapon(   595,  595,     0,   60, 15,   0,  1.00, "171",   55, "", "7.62mm", "SG-542");         //shock
    MainArmory[493] = new Weapon(   595,  595,     0,   80, 20,   0,  1.00, "266",   55, "", "7.62mm", "AG-3");           //elite
    MainArmory[492] = new Weapon(   595,  595,     0,   80, 20,   0,  1.00, "266",   55, "", "7.62mm", "AK4");            //Elite, kustjagare only
    MainArmory[987] = new Weapon(   595,  595,     0,   80, 20,   0,  1.00, "266",   55, "", "7.62mm", "FAL");            //elite, marinier
    MainArmory[719] = new Weapon(   595,  595,     0,   80, 20,   0,  1.00, "266",   55, "", "7.62mm", "L1A1 SLR");       //elite,

    //long rifles
    MainArmory[401] = new Weapon(   595,  595,     0,   40,  5,   0,  1.00,  "64",   55, "", "7.5mm", "Krag-Jorgensen");  //militia
    MainArmory[402] = new Weapon(   595,  595,     0,   40,  5,   0,  1.00,  "64",   55, "", "7.62mm", "M14");            //militia
    MainArmory[790] = new Weapon(   595,  595,     0,   40,  5,   0,  1.00,  "64",   55, "", "7.5mm", "MAS 49/56");       //militia
    MainArmory[490] = new Weapon(   595,  595,     0,   40,  5,   0,  1.00,  "64",   55, "", "7.5mm", "Mauser m/96");     //militia
    MainArmory[200] = new Weapon(   595,  595,     0,   40,  5,   0,  1.00,  "64",   55, "", "7.62mm", "vz.52");          //militia
    ...
    MainArmory[717] = new Weapon(   875,  595,     0,   40, 25,   0,  0.50, "428",   55, "[CQC]", "6.5mm", "Ksp m/58B");    //shock norrlandsjagare <<same as elite
    ...
    MainArmory[1122] = new Weapon(  875,  525,     0,   30, 20,   0,  0.50, "652",  55, "", "7.92mm", "M53 Šarac");             //veh
    ...
    MainArmory[1138] = new Weapon(  1050,  595,     0,   95, 20,   0,  1.00,  "15",   55, "", "7.62mm", "Dragunov SVD");// sissi
...
function SetTransports(){
    ...
    TransportArray[ 441][0] = [ 198, 185, 205, 676];
    ...
    TransportArray[ 864][1] = [ 829, 805, 810, 812, 802, 828, 836,   0,   0,   0,   0,   0,   0];
    TransportArray[ 865][1] = [ 829, 805, 810, 812, 802, 828, 836,   0,   0,   0,   0,   0,   0];
    ...
    TransportArray[ 869][1] = [ 827, 829, 805, 810, 812, 836, 843,   0,   0,   0,   0,   0,   0];
    ...
    TransportArray[ 873][1] = [ 829, 805, 810, 812, 802, 828, 836,   0,   0,   0,   0,   0,   0];
    TransportArray[ 874][1] = [ 829, 805, 810, 812, 802, 828, 836,   0,   0,   0,   0,   0,   0];
    ...
    TransportArray[ 925][1] = [ 953, 964, 942, 970,   0,   0,   0,   0,   0,   0,   0,   0,   0];
    TransportArray[ 926][1] = [ 953, 964, 907, 908, 970,   0,   0,   0,   0,   0,   0,   0,   0];
    TransportArray[ 927][1] = [ 964, 907, 908, 944, 945, 946,   0,   0,   0,   0,   0,   0,   0];
    TransportArray[ 928][1] = [ 964, 907, 908, 944, 945, 946,   0,   0,   0,   0,   0,   0,   0];
    TransportArray[ 929][1] = [ 964, 907, 908, 944, 945, 946,   0,   0,   0,   0,   0,   0,   0];
    TransportArray[ 930][1] = [ 964, 907, 908, 971,   0,   0,   0,   0,   0,   0,   0,   0,   0];
    TransportArray[ 931][1] = [ 964, 907, 908, 944, 945, 946,   0,   0,   0,   0,   0,   0,   0];
    TransportArray[ 932][1] = [ 964, 907, 908, 944, 945, 946,   0,   0,   0,   0,   0,   0,   0];
