...
{"use strict";                             //ground,helo   air,  acc,stab,ap, he,   rof,   supp, tags, rounds name
    ...
    MainArmory[484] = new Weapon(   525,  525,     0,   45, 23,   0,  1.00, "232",   40, "", "5.45mm", "kbk Tantal");
...
function SetTransports(){
    ...
    TransportArray[  42][0] = [ 332, 384, 282, 290, 674];
    TransportArray[ 106][0] = [ 384, 527, 613, 615];
    ...
    TransportArray[ 148][0] = [ 419, 847, 470, 824];
    TransportArray[ 518][0] = [ 847, 470, 824];
    TransportArray[ 811][0] = [ 847, 470, 824];
    TransportArray[ 217][0] = [ 847, 470, 118, 632, 634];
    ...
    TransportArray[ 808][0] = [ 419, 847, 470, 632, 634, 824];
    ...
    TransportArray[  31][0] = [ 522,  48, 279, 280,  37, 616];
    TransportArray[  27][0] = [ 522,  48,  37, 616];
    ...
    TransportArray[ 447][0] = [ 203, 198, 185, 205, 670, 682, 676];
    TransportArray[ 435][0] = [ 203, 205, 670, 682, 676];
    ...
    TransportArray[ 226][1] = [ 424, 425, 421, 422, 202, 203,  98, 100, 101, 658, 644, 529, 706];
    ...
    TransportArray[ 146][1] = [ 441, 247, 670, 240, 250, 251, 685, 488, 490,   0,   0,   0,   0];
    TransportArray[ 663][1] = [ 441, 250, 251, 685, 509, 508, 488, 490,   0,   0,   0,   0,   0];
    ...
    TransportArray[ 159][1] = [ 441, 250, 251, 685, 488, 490,   0,   0,   0,   0,   0,   0,   0];
    ...
    TransportArray[ 660][1] = [ 272, 236, 237, 238, 683, 531, 707, 643, 713, 530,   0,   0,   0];
    ...
    TransportArray[ 276][1] = [ 236, 237, 238, 683, 199, 200, 201, 229, 531, 707,   0,   0,   0];
    ...
    TransportArray[ 133][1] = [ 272, 236, 237, 238, 683, 643, 713, 530,   0,   0,   0,   0,   0];
    ...
    TransportArray[ 112][1] = [ 256, 339, 651, 525, 527,   0,   0,   0,   0,   0,   0,   0,   0];
